...
def get_linalg_operations(mlir_code):
    ...
    with Context() as managed_ctx:
        ...
        # print(len(main_blocks))
        # print('\n\n'.join([str(op) for op in main_blocks[0].body.blocks[0].operations if "linalg." in str(op)]))
...
if __name__ == '__main__':
    ...
    # mlir_linalg_path = 'examples/x1.mlir'
    mlir_linalg_path = 'generated_mlir/nn.mlir'
    mlir_linalg_path = 'generated_mlir/bigger_input_nn.mlir'
    with open(mlir_linalg_path, 'r') as file:
        mlir_linalg = file.read()
    ...
    data = []
    for operation in tqdm(linalg_operations):
        ...
        # print(len(loops_data['nested_loops']))
        # print('*'*20)
    ...
    # print(data)
    # with open('generated_data/bigger_input_nn_(32x230x230x3)operations.json', 'w') as file:
    #     json.dump(data, file)