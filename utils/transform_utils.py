...
def apply_conv_2d_nhwc_hwcf_decomposition(code, tmp_file):
    code = code.strip()
...
def apply_conv_2d_nchw_fchw_decomposition(code, tmp_file):
    code = code.strip()
...
def apply_conv_2d_nhwc_fhwc_decomposition(code, tmp_file):
    code = code.strip()
...
def apply_maxpool_decomposition(code, tmp_file):
    code = code.strip()
