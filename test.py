...
module attributes {torch.debug_module_name = "Net"} {
  ...
  %return_arg = linalg.conv_2d_nchw_fchw {dilations = dense<1> : vector<2xi64>, strides = dense<2> : vector<2xi64>, tag = "operation_1"} ins (%input, %filter: tensor<32x3x230x230xf32>, tensor<64x3x7x7xf32>) outs (%init: tensor<32x64x112x112xf32>) -> tensor<32x64x112x112xf32>
...
code = transform_dialect_img2col(code, "operation_1")

code = transform_dialect_TP(code, "operation_1", [0, 28, 4, 7])
# code = transform_dialect_tile(code, "operation_1", [2, 112, 0, 21])

# code = transform_dialect_vectorise(code, "operation_1")
